...
var validSelectors = [
  ...
  {name: "Universal selector, matching all descendents of element with specified ID",    selector: "#universal *",   expect: ["universal-p1", "universal-code1", "universal-hr1", "universal-pre1", "universal-span1", "universal-p2", "universal-a1", "universal-address1", "universal-code2", "universal-a2"], level: 2, testType: TEST_QSA | TEST_MATCH},
  ...
  {name: "Descendant combinator, matching element that is a descendent of an element with id",                 selector: "#descendent div",                   expect: ["descendent-div1", "descendent-div2", "descendent-div3", "descendent-div4"], level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element",                 selector: "body #descendent-div1",             expect: ["descendent-div1"], exclude: ["detached", "fragment"], level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element",                 selector: "div #descendent-div1",              expect: ["descendent-div1"],                                    level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element with id",         selector: "#descendent #descendent-div2",      expect: ["descendent-div2"],                                    level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, matching element with class that is a descendent of an element with id",      selector: "#descendent .descendent-div2",      expect: ["descendent-div2"],                                    level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, matching element with class that is a descendent of an element with class",   selector: ".descendent-div1 .descendent-div3", expect: ["descendent-div3"],                                    level: 1, testType: TEST_QSA | TEST_MATCH},
  {name: "Descendant combinator, not matching element with id that is not a descendent of an element with id", selector: "#descendent-div1 #descendent-div4", expect: [] /*no matches*/,                                      level: 1, testType: TEST_QSA},
  {name: "Descendant combinator, whitespace characters",                                                       selector: "#descendent\t\r\n#descendent-div2", expect: ["descendent-div2"],                                    level: 1, testType: TEST_QSA | TEST_MATCH},
...
// XXX Fix ctx in tests below
  ...
  // Combinators
  // - Descendant combinator ' '
  {name: "Descendant combinator, matching element that is a descendent of an element with id (1)",                 selector: "#descendent div",                   ctx: "", expect: ["descendent-div1", "descendent-div2", "descendent-div3", "descendent-div4"], level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element (1)",                 selector: "body #descendent-div1",             ctx: "", expect: ["descendent-div1"], exclude: ["detached", "fragment"], level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element (1)",                 selector: "div #descendent-div1",              ctx: "", expect: ["descendent-div1"],                                    level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, matching element with id that is a descendent of an element with id (1)",         selector: "#descendent #descendent-div2",      ctx: "", expect: ["descendent-div2"],                                    level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, matching element with class that is a descendent of an element with id (1)",      selector: "#descendent .descendent-div2",      ctx: "", expect: ["descendent-div2"],                                    level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, matching element with class that is a descendent of an element with class (1)",   selector: ".descendent-div1 .descendent-div3", ctx: "", expect: ["descendent-div3"],                                    level: 1, testType: TEST_FIND | TEST_MATCH},
  {name: "Descendant combinator, not matching element with id that is not a descendent of an element with id", selector: "#descendent-div1 #descendent-div4", ctx: "", expect: [] /*no matches*/,                                      level: 1, testType: TEST_FIND},
  {name: "Descendant combinator, whitespace characters (1)",                                                       selector: "#descendent\t\r\n#descendent-div2", ctx: "", expect: ["descendent-div2"],                                    level: 1, testType: TEST_FIND | TEST_MATCH},
